'''
    SVM + sentiment analysis + cross validation + word and char ngram
'''
...
from svm_classifier.es_classifier.es_a_classifier_1 import normalizer, tokenize
...
if __name__ == "__main__":
    ...
    file_test = readfile('../../datasets/public_development_es/dev_es.tsv')
    test = pd.DataFrame()
    test['id'] = file_test[0]
